/**
 * Service Coordinator для market-price-calculator-service
 * 
 * Этот сервис:
 * - Устанавливает свой статус 'running' при начале расчета
 * - Устанавливает статус 'completed' при успехе
 * - Устанавливает статус 'failed' при ошибке
 * - Позволяет другим сервисам (analytics) проверять статус
 */
