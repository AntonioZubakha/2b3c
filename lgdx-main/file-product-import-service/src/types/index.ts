...
export interface IProduct {
  ...
  company?: Types.ObjectId | ICompany; // MongoDB ObjectId ref to Company
  ...
  history?: Array<{ date: Date; price: number }>; // Price history or other audit trails
...
// Ensure this list is comprehensive and matches helpers.ts
export type DealStatus = 
  'pending' | 'rejected' | 'cancelled' | 
  // Negotiation statuses removed: 'approved', 'negotiating', 'terms_proposed', 'seller_counter_offer', 'seller_final_offer', 'terms_accepted'
  'alternative_product_proposed' |
  'awaiting_invoice' | 'invoice_pending' | 'awaiting_payment' | 'payment_received' | 'shipped' | 'completed' | 
  'shipping_documents_uploaded' | 'delivery_confirmed' | 'payment_pending' | 'awaiting_shipping_documents' | 'invoice_accepted';
...
export interface InventoryProcessingStats {
  ...
  errors?: Array<{ 
    ...
    stockNumber?: string; 
    certificateNumber?: string;
    rawDataSource?: Record<string, unknown>;
    stack?: string;
