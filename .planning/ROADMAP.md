...
- [x] **Phase 4: Бренд и локаль РФ** — 2B3C в UI/копирайте, основы локализации под РФ. *(2026-05-14)*
...
- [x] 04-01-PLAN.md — Read-only аудит: GAP BRD-01/02 vs UI/SEO/i18n, multi-source coverage *(2026-05-14)*
- [x] 04-02-PLAN.md — Реализация: 2B3C в i18n + chrome + index.html/Seo; чеклист РФ в info/PRODUCT.md; test+lint *(2026-05-14)*
...
| 4. Бренд и РФ | 2/2 | Complete | 2026-05-14 |
