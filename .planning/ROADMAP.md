...
- [ ] **Phase 2: Чекаут и заказ** — оплата и статусы заказа для обоих путей.
...
- [ ] 02-01: Сверка order-service + gateway с двумя сценариями — PLAN.md
- [ ] 02-02: Правки чекаута и webhooks при необходимости — PLAN.md
...
| 2. Чекаут и заказ | 0/TBD | Not started | - |
