...
- [ ] **Phase 2: Чекаут и заказ** — оплата и статусы заказа для обоих путей. *(план: 2026-05-14)*
- [ ] **Phase 3: Трекинг** — изготовление/доставка понятны покупателю.
...
- [ ] 02-01-PLAN.md — Аудит: jewelry / bespoke / diamond через корзину → checkout → order; gateway; GAP vs ORD-01/ORD-02
- [ ] 02-02-PLAN.md — Реализация и docs: order-service/frontend/gateway по GAP; info/API, SECURITY, FRONTEND; smoke
...
| 2. Чекаут и заказ | 0/2 | 2 planned | - |
